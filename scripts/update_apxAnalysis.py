...
joshuaData = process('../drivers/joshua.json')
sonnyData = process('../drivers/sonny.json')

joshua = open('../drivers/joshua.json','w', encoding='utf-8')
json.dump(joshuaData, joshua, indent=4, ensure_ascii=False)
joshua.close()
sonny = open('../drivers/sonny.json','w', encoding='utf-8')
json.dump(sonnyData, sonny, indent=4, ensure_ascii=False)
sonny.close()
